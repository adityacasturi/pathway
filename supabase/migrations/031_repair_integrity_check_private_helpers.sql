-- Migration 031: keep production integrity checks working after privileged
-- helper functions moved out of the public schema.
...
revoke all on function public.production_integrity_check() from public, anon, authenticated;
