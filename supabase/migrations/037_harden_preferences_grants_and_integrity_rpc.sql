-- Migration 037: align table grants with RLS and move the private production
-- integrity check out of the exposed public schema.
...
drop function if exists public.production_integrity_check();
