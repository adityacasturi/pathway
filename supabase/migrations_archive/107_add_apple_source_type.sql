-- Apple Discover source: jobs.apple.com SSR search hydration (US + intern query).
...
values (
  (select id from public.companies where slug = 'apple'),
  'apple',
  'apple-careers',
  'https://jobs.apple.com/en-us/search?location=united-states-USA&search=intern',
  'en-us',
  true,
  240
)
