-- Salesforce Discover source: careers.salesforce.com public RSS job export (Phenom/Umbraco).
...
values
  (
    (select id from public.companies where slug = 'salesforce'),
    'salesforce',
    'salesforce-careers-rss',
    'https://careers.salesforce.com/en/jobs/xml/?rss=true',
    'en',
    true,
    240
  )
