-- Wayfair Discover source: internal job_search_data API (verified May 2026).
-- Greenhouse boards-api token "wayfair" is not published; careers at wayfair.com/careers/jobs.
...
values
  (
    (select id from public.companies where slug = 'wayfair'),
    'wayfair',
    'wayfair-careers',
