-- Snap Inc. Discover source: Workday CXS (snapchat.wd1.myworkdayjobs.com/sourced).
...
values
  (
    (select id from public.companies where slug = 'snap'),
    'workday',
    'snap-workday',
    'https://snapchat.wd1.myworkdayjobs.com/sourced',
    'sourced',
    true,
    240
  )
