-- PEAK6 Discover source: Ongig careers embed (group_id 1767; verified May 2026).
-- Standard Greenhouse/Lever boards are not published; jobs via text-analyzer.ongig.com search API.
...
values
  (
    (select id from public.companies where slug = 'peak6'),
    'peak6',
    'peak6-ongig',
    'https://www.peak6.com/careers/',
    '1767',
