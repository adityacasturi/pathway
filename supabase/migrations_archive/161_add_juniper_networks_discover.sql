-- Juniper Networks Discover source: HPE Workday Jobsathpe with juniper-scoped search (May 2026).
-- Careers redirect to careers.hpe.com/juniper after HPE acquisition.
...
values
  (
    (select id from public.companies where slug = 'juniper-networks'),
    'juniper_networks',
    'juniper-networks-hpe-workday',
