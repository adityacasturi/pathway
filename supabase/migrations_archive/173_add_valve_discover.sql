-- Valve Discover source: custom JSON job search at valvesoftware.com (verified May 2026).
-- GH/Lever tokens 404; /en/jobs/job-search?search=a returns all open roles.
...
values
  (
    (select id from public.companies where slug = 'valve'),
    'valve',
    'valve-careers',
    'https://www.valvesoftware.com/en/jobs/job-search?search=a',
    'a',
    true,
    240
  )
