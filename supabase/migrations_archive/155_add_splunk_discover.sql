-- Splunk Discover source: Cisco Workday Cisco_Careers with Splunk-focused search (May 2026).
-- Standalone splunk.wd5 board is retired; internships list on careers.cisco.com/splunk via Cisco Workday.
...
values
  (
    (select id from public.companies where slug = 'splunk'),
    'splunk',
    'splunk-cisco-workday',
