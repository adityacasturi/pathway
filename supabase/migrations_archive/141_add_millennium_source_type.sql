-- Millennium Management Discover source: Eightfold PCS at mlp.eightfold.ai (campus microsite; verified May 2026).
...
values (
  ...
  'https://www.mlp.com',
  'https://mlp.eightfold.ai/careers?microsite=campus-site',
  'quant'
)
...
values
  (
    (select id from public.companies where slug = 'millennium'),
    'millennium',
    'millennium-eightfold-campus',
    'https://mlp.eightfold.ai/careers?microsite=campus-site&query=intern',
    'mlp.com',
    true,
    240
  )
