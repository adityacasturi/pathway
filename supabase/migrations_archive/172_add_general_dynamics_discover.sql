-- General Dynamics Discover source: Sitecore CareerSearch API at gd.com (verified May 2026).
-- Parent-company Workday hosts (gd.wd1) are not published; GDIT Workday is subsidiary-only.
...
values
  (
    (select id from public.companies where slug = 'general-dynamics'),
    'general_dynamics',
    'general-dynamics-sitecore',
    'https://www.gd.com/careers/job-search',
    'intern',
    true,
    240
  )
