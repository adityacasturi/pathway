-- Seagate Discover source: SAP SuccessFactors / Jibe careers search at seagatecareers.com (May 2026).
-- Workday hosts 422; public paginated search + job pages are stable.
...
values
  (
    (select id from public.companies where slug = 'seagate'),
    'seagate',
    'seagate-careers-search',
    'https://seagatecareers.com/search/',
    'intern',
    true,
    240
  )
