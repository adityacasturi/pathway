-- Analog Devices Discover source: Workday CXS External (verified May 2026).
-- CXS: analogdevices.wd1.myworkdayjobs.com/wday/cxs/analogdevices/External/jobs
...
values
  (
    (select id from public.companies where slug = 'analog-devices'),
    'workday',
