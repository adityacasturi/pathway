-- Bloomberg Discover source: Avature careers portal (May 2026).
-- bloomberg.avature.net/careers/SearchJobs (portal 4). Not on Greenhouse/Workday.
...
values
  (
    (select id from public.companies where slug = 'bloomberg'),
    'bloomberg',
    'bloomberg-avature',
    'https://bloomberg.avature.net/careers/SearchJobs',
    '4',
