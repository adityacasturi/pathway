-- Runway (runwayml.com) Discover source: Ashby board runway-ml (verified May 2026).
-- Not Rent the Runway (rent-the-runway). Public API: api.ashbyhq.com/posting-api/job-board/runway-ml
...
values
  (
    (select id from public.companies where slug = 'runway'),
    'ashby',
    'runway-ashby',
