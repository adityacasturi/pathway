-- Intuit Discover source: Radancy TalentBrew HTML search at jobs.intuit.com (org 27595).
...
values
  (
    (select id from public.companies where slug = 'intuit'),
    'intuit',
    'intuit-talentbrew',
    'https://jobs.intuit.com/search-jobs?k=internship&l=&listFilterMode=1',
    'internship',
    true,
    240
  )
