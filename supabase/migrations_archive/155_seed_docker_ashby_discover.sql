-- Docker Discover source: Ashby board docker (verified May 2026).
-- Public API: api.ashbyhq.com/posting-api/job-board/docker
...
values
  (
    (select id from public.companies where slug = 'docker'),
    'ashby',
    'docker-ashby',
    'https://jobs.ashbyhq.com/docker',
    'docker',
