-- Marvell Discover source: Workday CXS (verified May 2026).
-- Public CXS: marvell.wd1.myworkdayjobs.com/MarvellCareers
...
values
  (
    (select id from public.companies where slug = 'marvell'),
    'workday',
    'marvell-workday',
    'https://marvell.wd1.myworkdayjobs.com/en-US/MarvellCareers',
    'MarvellCareers',
