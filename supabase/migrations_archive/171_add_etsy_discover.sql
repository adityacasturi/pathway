-- Etsy Discover source: Clinch Talent at careers.etsy.com (verified May 2026).
-- Greenhouse token "etsy" is not published; job URLs are listed in public sitemap.xml.
...
values
  (
    (select id from public.companies where slug = 'etsy'),
    'etsy',
    'etsy-clinch',
    'https://careers.etsy.com/jobs/search',
    null,
    true,
    240
  )
