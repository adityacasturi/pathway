-- Hudson River Trading Discover source: Greenhouse talent community board (May 2026).
-- Careers site embeds job-boards.greenhouse.io/hrttalentcommunity (not hudsonrivertrading slug).
...
values
  (
    (select id from public.companies where slug = 'hudson-river-trading'),
    'hudson_river_trading',
