-- ServiceNow Discover source: SmartRecruiters public API (company id ServiceNow).
-- careers.servicenow.com is Phenom/iCIMS front-end; apply URLs use jobs.smartrecruiters.com.
...
values
  (
    (select id from public.companies where slug = 'servicenow'),
    'smartrecruiters',
