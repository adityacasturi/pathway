-- Goldman Sachs Discover source: Oracle Fusion CE REST (hdpc.fa.us2.oraclecloud.com, campus site CX_3001).
...
values
  (
    (select id from public.companies where slug = 'goldman-sachs'),
    'goldman_sachs',
    'goldman-sachs-oracle-ce',
    'https://higher.gs.com/campus',
    'CX_3001',
    true,
    240
