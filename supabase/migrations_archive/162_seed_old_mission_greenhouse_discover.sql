-- Old Mission Discover source: Greenhouse board oldmissioncapital (verified May 2026).
...
values
  (
    (select id from public.companies where slug = 'old-mission'),
    'greenhouse',
    'old-mission-greenhouse',
