-- Sourcegraph Discover source: Greenhouse board sourcegraph91 (verified May 2026).
-- Token "sourcegraph" 404; careers page embeds job-boards.greenhouse.io/sourcegraph91.
...
values
  (
    (select id from public.companies where slug = 'sourcegraph'),
    'greenhouse',
