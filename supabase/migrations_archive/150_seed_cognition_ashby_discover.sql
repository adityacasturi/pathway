-- Cognition Discover source: Ashby board cognition (verified May 2026).
-- Public API: https://api.ashbyhq.com/posting-api/job-board/cognition
...
values
  (
    (select id from public.companies where slug = 'cognition'),
    'ashby',
    'cognition-ashby',
    'https://jobs.ashbyhq.com/cognition',
    'cognition',
