-- Tower Research Discover source: Greenhouse board towerresearchcapital (May 2026).
...
values (
  ...
  'https://tower-research.com',
  'https://tower-research.com/careers/',
  'quant'
)
...
values
  (
    (select id from public.companies where slug = 'tower-research'),
    'tower_research',
