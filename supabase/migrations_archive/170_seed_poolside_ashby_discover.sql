-- Poolside (poolside.ai) Discover source: Ashby board poolside (verified May 2026).
-- Public API: api.ashbyhq.com/posting-api/job-board/poolside
...
values
  (
    (select id from public.companies where slug = 'poolside'),
    'ashby',
    'poolside-ashby',
    'https://jobs.ashbyhq.com/poolside',
    'poolside',
