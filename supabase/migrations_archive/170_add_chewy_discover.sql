-- Chewy Discover source: Phenom Career Connect refNum CHINUS (verified May 2026).
-- Greenhouse token "chewy" is not published; jobs via careers.chewy.com/widgets refineSearch.
...
values
  (
    (select id from public.companies where slug = 'chewy'),
    'chewy',
    'chewy-phenom',
    'https://careers.chewy.com/us/en/search-results',
    'CHINUS',
