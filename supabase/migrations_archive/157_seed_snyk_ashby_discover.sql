-- Snyk (snyk.io) Discover source: Ashby board snyk (verified May 2026).
-- Public API: api.ashbyhq.com/posting-api/job-board/snyk
...
values
  (
    (select id from public.companies where slug = 'snyk'),
    'ashby',
    'snyk-ashby',
    'https://jobs.ashbyhq.com/snyk',
    'snyk',
