-- Zendesk Discover source: Workday CXS Zendesk (verified May 2026).
-- CXS: zendesk.wd1.myworkdayjobs.com/wday/cxs/zendesk/Zendesk/jobs
...
values
  (
    (select id from public.companies where slug = 'zendesk'),
    'workday',
    'zendesk-workday',
