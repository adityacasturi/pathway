-- IBM Discover source: Avature careers portal at ibmglobal.avature.net (portal 4, intern search).
...
values (
  ...
  'IBM',
  'https://www.ibm.com',
  'https://careers.ibm.com/en_US/careers/SearchJobs/intern',
  'big-tech'
)
...
values
  (
    (select id from public.companies where slug = 'ibm'),
    'ibm',
    'ibm-avature',
    'https://ibmglobal.avature.net/en_US/careers/SearchJobs/intern',
    '4',
    true,
    240
  )
