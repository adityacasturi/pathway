-- Two Sigma Discover source: Avature careers portal (May 2026).
-- careers.twosigma.com/careers/OpenRoles (portal 106). Not on Greenhouse.
...
values
  (
    (select id from public.companies where slug = 'two-sigma'),
    'two_sigma',
    'two-sigma-avature',
    'https://careers.twosigma.com/careers/OpenRoles',
    '106',
