-- JPMorgan Chase Discover source: Oracle Fusion CE REST at jpmc.fa.oraclecloud.com (CX_1001).
...
values
  (
    (select id from public.companies where slug = 'jpmorgan-chase'),
    'jpmorgan_chase',
    'jpmorgan-chase-oracle-ce',
    'https://jpmc.fa.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1001',
    'CX_1001',
    true,
    240
