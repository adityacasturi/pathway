-- Teradata Discover source: GR8 People GraphQL at careers.teradata.com (verified May 2026).
-- Greenhouse/workday hints incorrect; public API searchJobPostings with query "internship".
...
values
  (
    (select id from public.companies where slug = 'teradata'),
    'teradata',
    'teradata-gr8people',
