...
SQLite-backed queue for onboarding employers into the Discover catalog. Workers follow [.cursor/skills/discover-queue/SKILL.md](../.cursor/skills/discover-queue/SKILL.md).
...
| Supabase MCP | `apply_migration`, integrity check |
